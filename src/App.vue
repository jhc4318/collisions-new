...
import PIXI from 'phaser'; // eslint-disable-line no-unused-vars
        ...
        */
        ...
        function preload() {
            ...
            if (window.devicePixelRatio >= 1.5) {
                ...
                game.load.image('pstar', 'assets/pstarlatex@2x.png');
                game.load.image('qstar', 'assets/qstarlatex@2x.png');
                game.load.image('q1', 'assets/q1latex@2x.png');
                game.load.image('q2', 'assets/q2latex@2x.png');
                game.load.image('u1', 'assets/u1latex@2x.png');
                ...
                game.load.image('p1', 'assets/p1latex.png');
                game.load.image('pstar', 'assets/pstarlatex.png');
                game.load.image('qstar', 'assets/qstarlatex.png');
                game.load.image('q1', 'assets/q1latex.png');
                game.load.image('q2', 'assets/q2latex.png');
                game.load.image('u1', 'assets/u1latex.png');
                game.load.image('v1', 'assets/v1latex.png');
                game.load.image('v2', 'assets/v2latex.png');
            }
            console.log("test2");
        ...
        function create() {
            ...
            let labFrameText = game.add.text(16, 10, "Lab Frame", style);
            labFrameText.anchor.set(0, 0);
            uiGroup.add(labFrameText);

            let centreOfMassFrameText = game.add.text(16, ( canvasHeight / 3 + 10 ), "Centre of Mass Frame", style);
            centreOfMassFrameText.anchor.set(0, 0);
            uiGroup.add(centreOfMassFrameText);

            let vectorDiagramText = game.add.text(16, ( canvasHeight * 2 / 3 + 10 ), "Vector Diagram", style);
            ...
            let centreOfMass2 = mainGroup.create(canvasWidth / 2, canvasHeight / 2, "cofmPNG");
            centreOfMass2.z = 1;
